...
- **Eduardo Mauricio Vieira Cabral e Araujo**, nome artístico **Eduardo Mauer** — autoria individual, metodológica e académica. Não possui ORCID confirmado nesta documentação.
- **Nuno Filipe Fernandes Vieira Cabral e Araujo**, nome artístico **Nuno A.** — coautoria, investigação visual, fotografia, arte digital e contribuições visuais autorizadas. Não possui ORCID confirmado nesta documentação.

O registo ORCID `0009-0004-9132-2925` foi criado por Eduardo para representar a Associação MILK. Como ORCID identifica pessoas e não entidades institucionais, este número não é utilizado como identificador institucional válido da Associação nem atribuído a Eduardo ou Nuno.

Autoria individual, responsabilidade institucional, contribuição, publicação, manutenção e titularidade de direitos são funções distintas e devem permanecer separadas.
